...
export const decorationOptions: CakeOption[] = [
  ...
  {
    id: "khatam-motif",
    label: { en: "Khatam Motif" },
    description: { en: "The eight point star from Persian marquetry, piped fine." },
    priceDelta: 35,
    pricePerServing: 0,
    allergens: [],
    requires: [],
    featured: false,
    swatch: "#2e7266",
    visual: { role: "decoration", slot: "band", svgId: "khatam", count: 5, fill: "#2e7266" },
  },
  {
    id: "ruffles",
